...
public class AssNochmalNaechsterSpielerTest {

    private AssNochmalNaechsterSpieler assNochmalNaechsterSpieler;
    ...
    @Before
    public void init() {
        assNochmalNaechsterSpieler = new AssNochmalNaechsterSpieler();
    ...
    @Test
    public void gleicherSpielerWennAssLiegt() {
        Karte k1 = new Karte(KartenFarbe.HERZ, KartenWert.WERTAss);

        IPlayer aktuellerPlayer = assNochmalNaechsterSpieler
    ...
    @Test
    public void naechsterSpielerWennAssNichtLiegt() {
