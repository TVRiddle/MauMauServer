...
public class AssUndAchtNaechsterSpielerTest {

    private AssUndAchtNaechsterSpieler assUndAchtNaechsterSpieler;
    ...
    @Before
    public void init() {
        assUndAchtNaechsterSpieler = new AssUndAchtNaechsterSpieler();
    ...
    public void uebernaechsterSpielerWennAchtLiegt() {
        ...
        IPlayer aktuellerPlayer = assUndAchtNaechsterSpieler
